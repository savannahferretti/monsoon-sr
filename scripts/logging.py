...
# Function to fetch ERA5 cloud data
def get_era5():
    ...
    logger.info('ERA5 data fetched successfully')
    return ds

# Function to fetch IMERG V06 cloud data
def get_imerg():
...
if __name__=='__main__':
    ...
    try:
        ...
        logger.info("Processing IMERG precipitation data...")
        prdata = imerg.precipitationCal.where((imerg.precipitationCal!=-9999.9)&(imerg.precipitationCal>=0),np.nan)*24 # mm/hr to mm/day
        logger.info("Processing ERA5 surface pressure data...")
        psdata = era5.surface_pressure/100 # Pa to hPa
        logger.info("Processing ERA5 specific humidity data...")
        qdata  = era5.specific_humidity
        logger.info("Processing ERA5 temperature data...")
