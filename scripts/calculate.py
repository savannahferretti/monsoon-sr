...
def integrate_partial_layer(pref,pabove,pbelow,daabove,dabelow,bound):
    ...
    Returns:
    - xr.DataArray: DataArrya of values integrated over the partial layer
    '''
    dp = pbelow-pabove
...
def calc_bl_terms(thetaeb,thetael,thetaels,wb,wl):
    ...
    Returns:
    - tuple (cape, subsat, bl):
        cape (xr.DataArray): CAPEL DataArray
        subsat (xr.DataArray): SUBSATL DataArray
        bl (xr.DataArray): BL DataArray
    '''
    g       = 9.81
    kappal  = 3.
    thetae0 = 340.
